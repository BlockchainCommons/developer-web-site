...
* Do you want to package the PSBT for use in some far future time?
...
Which decodes as shown, pre `bitcoin-cli decodepsbt`:
```
{
  "tx": {
...
```
The hex then needs to be recorded as [a byte string in CBOR](https://datatracker.ietf.org/doc/html/rfc7049#section-2.1):
```
...
59 017F                                 # bytes(383)
    # 
```
That hex, with its prepended type & size, then needs to be converted into minimal bytewords and prepended again, this time with the `ur:psbt` tag so that it's self-describing:
```
