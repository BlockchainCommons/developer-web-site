...
```
The hex then needs to be recorded as [a byte string in CBOR](https://datatracker.ietf.org/doc/html/rfc7049#section-2.1), which means prepending its type ("2") and length (383 bytes):
```
...
59 017F                                 # bytes(383)
    # 
```
That hex with the prepended type & size then needs to be converted into minimal bytewords and prepended again, this time with the `ur:crypto-psbt` tag so that it's self-describing:
```
