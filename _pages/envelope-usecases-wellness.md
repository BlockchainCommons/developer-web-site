...
Ultimately, Wellness software can use Gordian Envelope to:
...
Gordian Envelope is useful for wellness because of their precise
...
new envelope that contains only the (elided) public key
...
An envelope like this would be generated for each close locale that
