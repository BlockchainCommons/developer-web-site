...
CBOR is a binary data format defined in [RFC 8949](https://datatracker.ietf.org/doc/html/rfc8949). It is the foundation of most of Blockchain Commons' data formats. [Envelope](/envelope/) is built using CBOR, while [URs](/ur/) and [MURs](/ur/mur/) can be used to encode CBOR as four-letter English words (or in minimalistic form, as two letters).
